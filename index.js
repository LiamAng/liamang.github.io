...
const assets = {
    images: {
        ...
        book: assetsPrefix + "textures/item/book.png",
...
const cssImageAssets = [
    [assets.images.button, "--btn-bg"],
    [assets.images.text_feild, "--tf-bg"],
    [assets.images.button_highlight, "--btn-bg-hover"],
    [assets.images.text_feild_highlight, "--tf-bg-hover"],
    [assets.images.menu, "--m-bg"],
    [assets.images.menu_list, "--ml-bg"],
    [assets.images.footer_separator, "--fs"],
    [assets.images.header_separator, "--hs"],
    [assets.images.join, "--join"],
    [assets.images.join_highlight, "--join-hover"],
    [assets.images.book, "--abt-icon"],
];
cssImageAssets.forEach(([url, cssVar]) => loadImage(url, cssVar));
...
document.addEventListener(pressEvent, (e) => {
...
function setupTabs(tabTitles, loadFn) {
    tabs.innerHTML = "";
...
document.getElementById("flowchart-button").onclick = () => {
    setupTabs(["Sequence", "Selection", "Iteration"], loadFlowcharts);
};

document.getElementById("projects-button").onclick = () => {
    setupTabs(["School", "Hobby"], loadProjects);
};
